...
archivo_grafo = 'grafo_estrellas.gpickle'
archivo_copia = 'grafo_estrellas_backup.gpickle'
archivo_grafo_csv = 'grafo.csv'
...
def crear_grafo():
    ...
    print(f'Leidas {data.size} estrellas de estrellas.csv')
    ...
    for index, row in data.iterrows():
        ...
        atributos = {
            ...
            'divergencia':v[divergencia]   #divergencia velocidad teorica t1 - velocidad real
            }
